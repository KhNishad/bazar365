...
const Best_seller = ({id,name,img,price,weight,plastic_icon}) => (
                    ...
                    <div id={id}>
                        <div className={styles.photo}>
                            ...
                            <div className={styles.overlay} >
                                <div className={styles.divoverlay}>
                                    ...
                                    <h3 className={styles.addtocartshow, styles.show} ng-click="CartsWidget()" style={{marginTop:"40%"}}>Add to cart</h3>
                                </div>
                                {/* <!--View details--> */}
                                <a className={`${styles.btnshow} lozad`} href="/product/<%= x.productSlug %>" target="_self">Show Details</a>
                                {/* <!--modal-open-end--> */}
                        ...
                        {/* <!--View details 4 mobile--> */}
                            ...
                            <a style={{display: "none;"}} className={styles.btnshow, styles.details_mobile} href="#" target="_self"></a>
                        ...
                        <div className={styles.info}>
                            <div className={styles.price_details}>
                                <div className={styles.info2} >
                                    <div className={styles.price_details}>
                                        <h3 className='text-left'><a href="#" target="_self">{name}</a></h3>
                                ...
                                <div className={styles.price_details, styles.carousel_card_footer}>
                                    <div className={styles.p_info}>
                                        <span className={`${styles.addToCartDiscountPrice , styles.price_new}`} style={{color:' #93c244'}}>{price}</span>                                               
                                    ...
                                    <div className={styles.add_to_cart}>
                                        ...
                                        <div className={styles.cart_div}>
                                            <span>
                                                <img className={styles.cart_img} src="/img/bazar365-cart-icon-white.png"  alt="cart"/>
                                            </span>
                                            <span className={styles.shopping_cart_quantityShow ,styles.hide}> </span>
